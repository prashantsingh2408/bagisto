                                      ...
                                      <span>
                                          ...
                                          @auth('customer')
                                            <a class="unset"
                                              ...
                                              {{ __('velocity::app.responsive.header.greeting', [
    'customer' => auth()->guard('customer')->user()->first_name,
                                  ...
                                  @auth('customer')
                                    <ul type="none"
                                      ...
                                      <li>
                                        <a href="{{ route('customer.downloadable_products.index') }}"
                                           class="unset">
                              ...
                              <div class="wrapper" v-else-if="languages">
                                  ...
                                  <ul type="none">
                                      @foreach ($allLocales as $locale)
                                        <li>
                                          <a class="unset"
                                             @if (isset($serachQuery)) href="?{{ $serachQuery }}&locale={{ $locale->code }}"
                                                                                    @else
                                                                                          href="?locale={{ $locale->code }}" @endif>
