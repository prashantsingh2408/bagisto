...
@push('scripts')
  <script type="text/x-template"
    ...
    <a
                                                                                                                                              ...
                                                                                                                                              @else
                                                                                                                                                <img class="logo"
                                                                                                                                                     src="{{ asset('themes/velocity/assets/images/logo-text.png') }}"
                                                                                                                                                     alt=""
                                                                                                                                                     class="img-fluid" />
                                                                                                                                              @endif
                                                                                                                                          </a>
                                                                                                                                              ...
                                                                                                                                              <div class="row">
                                                                                                                                                  ...
                                                                                                                                                  <div class="col-lg-6 col-md-12 vc-full-screen">
                                                                                                                                                      ...
                                                                                                                                                      <div class="left-wrapper">
                                                                                                                                                          ...
                                                                                                                                                          {{-- Smart User --}}
                                                                                                                                                            @auth('customer')
                                                                                                                                                              <form action="{{ route('customer.register.index_smart') }}"
                                                                                                                                                                    method='GET'
                                                                                                                                                                    id='smart_form'
      ...
      Vue.component('searchbar-component', {
        ...
        data: function() {
          return {
            ...
            wishlistCount: 0,
            searchedQuery: [],
            isCustomer: '{{ auth()->guard('customer')->user()
    ? 'true'
    : 'false' }}' == "true",
          }
        },
                ...
                if (imageInput.files[0].size <= 2000000) {
                  ...
                  axios.post(
                    ...
                    async function app() {
                      ...
                      window.location.href = "{{ route('shop.search.index') }}" + '?term=' +
