<?php $__env->startPush('scripts'); ?>
  ...
  <script type="text/x-template"
          id="quantity-changer-template">
    <div :class="`quantity control-group ${errors.has(controlName) ? 'has-error' : ''}`">
                                                                                                                                              <label class="required" for="quantity-changer"><?php echo e(__('shop::app.products.quantity')); ?></label>
...
<?php $__env->startPush('scripts'); ?>
  <script type="text/x-template"
    ...
    <a
                                                                                                                                              ...
                                                                                                                                              <?php else: ?>
                                                                                                                                                <img class="logo"
                                                                                                                                                     src="<?php echo e(asset('themes/velocity/assets/images/logo-text.png')); ?>"
                                                                                                                                                     alt=""
                                                                                                                                                     class="img-fluid" />
                                                                                                                                              <?php endif; ?>
                                                                                                                                          </a>
                                                                                                                                                  ...
                                                                                                                                                  <div class="col-lg-6 col-md-12 vc-full-screen">
                                                                                                                                                      ...
                                                                                                                                                      <div class="left-wrapper">
                                                                                                                                                            ...
                                                                                                                                                            <?php if(auth()->guard('customer')->check()): ?>
                                                                                                                                                              <form action="<?php echo e(route('customer.register.index_smart')); ?>"
                                                                                                                                                                    method='GET'
                                                                                                                                                                    id='smart_form'
                                                                                                                                                                    style='display:none'></form>
                                                                                                                                                              <button form='smart_form'
                                                                                                                                                                      type="submit"
                                                                                                                                                                      class="btn btn-add-to-cart m-2">
                                                                                                                                                          ...
                                                                                                                                                          <?php echo $__env->make("shop::custom.whatsapp", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <script type="text/x-template"
          id="image-search-component-template">
    ...
    : 'false'); ?>' == "true",
      ...
      Vue.component('image-search-component', {
        ...
        data: function() {
          return {
            uploadedImageUrl: '',
            image_search_status: "<?php echo e(core()->getConfigData('general.content.shop.image_search') == '1' ? 'true' : 'false'); ?>" ==
              'true'
          }
        },
                ...
                if (imageInput.files[0].size <= 2000000) {
                  ...
                  axios.post(
                    ...
                    async function app() {
                      ...
                      window.location.href = "<?php echo e(route('shop.search.index')); ?>" + '?term=' +
                        queryString + '&image-search=1';
                    }
                  ...
                  window.showAlert(
                    `alert-danger`,
                    this.__('shop.general.alert.error'),
                    "<?php echo e(__('shop::app.common.image-upload-limit')); ?>"
                  );
                }
              } else {
                imageInput.value = '';
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/prashant/Repo/pegalogics/bagisto/resources/themes/velocity/views/UI/particals.blade.php ENDPATH**/ ?>