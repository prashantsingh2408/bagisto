                            ...
                            <div class="control-group">
                                <select class="control" id="channel-switcher" name="channel"
                                    ...
                                    <?php $__currentLoopData = $results['extraFilters']['channels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channelModel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($channelModel->code); ?>"
                                            <?php echo e((isset($channel) && ($channelModel->code) == $channel) ? 'selected' : ''); ?>>
                        ...
                        <div class="dropdown-filters per-page">
                            <div class="control-group">
                                <select class="control" id="locale-switcher" name="locale"
                                    ...
                                    <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localeModel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
            ...
            Vue.component('datagrid-filters', {
                ...
                data: function () {
                    return {
                        ...
                        massActionConfirmText: '<?php echo e(__('ui::app.datagrid.click_on_action')); ?>',
                        massActionType: null,
                        massActionValues: [],
                        massActionTargets: [],
                        ...
                        perPage: <?php echo e($results['itemsPerPage'] ?: 10); ?>,
...
<?php /**PATH /home/prashant/Repo/pegalogics/bagisto/packages/Webkul/Ui/src/Providers/../Resources/views/datagrid/table.blade.php ENDPATH**/ ?>