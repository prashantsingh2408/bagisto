                                  ...
                                  <div class="greeting drawer-section fw6">
                                      ...
                                      <span>
                                          <?php if(auth()->guard('customer')->guest()): ?>
                                            <a class="unset"
                                               href="<?php echo e(route('customer.session.index')); ?>">
                                              <?php echo e(__('velocity::app.responsive.header.greeting', ['customer' => 'Guest'])); ?>
                                          ...
                                          <?php if(auth()->guard('customer')->check()): ?>
                                            <a class="unset"
                                               href="<?php echo e(route('customer.profile.index')); ?>">
                                              <?php echo e(__('velocity::app.responsive.header.greeting', [
    'customer' => auth()->guard('customer')->user()->first_name,
])); ?>
                                  ...
                                  <?php $__currentLoopData = $allLocales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appLocale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($appLocale->code == $currentLocale): ?>
                                      <?php
                                        $locale = $appLocale;
                                      ?>
                                    <?php endif; ?>
                                  ...
                                  <?php $__currentLoopData = $allCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appCurrency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($appCurrency->code == $currentCurrency): ?>
                                      <?php
                                  ...
                                  <?php if(auth()->guard('customer')->check()): ?>
                                    <ul type="none"
                                      ...
                                      <li>
                                        <a href="<?php echo e(route('customer.address.index')); ?>"
                                           class="unset">
                                      ...
                                      <li>
                                        <a href="<?php echo e(route('customer.reviews.index')); ?>"
                                           class="unset">
                                      ...
                                      <?php if(core()->getConfigData('general.content.shop.wishlist_option')): ?>
                                        <li>
                                          <a href="<?php echo e(route('customer.wishlist.index')); ?>"
                                             class="unset">
                                      ...
                                      <li>
                                        <a href="<?php echo e(route('customer.downloadable_products.index')); ?>"
                                           class="unset">
                                  ...
                                  <ul type="none" class="meta-wrapper">
                                      <li>
                                          <?php if($locale): ?>
                                            <div class="language-logo-wrapper">
                                              <?php if($locale->locale_image): ?>
                                                <img class="language-logo"
                                                     src="<?php echo e(asset('/storage/' . $locale->locale_image)); ?>"
                                                     alt="" />
                                              <?php elseif($locale->code == "en"): ?>
                                                <img class="language-logo"
                                                     src="<?php echo e(asset('/themes/velocity/assets/images/flags/en.png')); ?>"
                                                     alt="" />
                                              <?php endif; ?>
                                            </div>
                                      ...
                                      <li>
                                          <?php if(auth()->guard('customer')->check()): ?>
                                            <a class="unset"
                                               href="<?php echo e(route('customer.session.destroy')); ?>">
                                              <span><?php echo e(__('shop::app.header.logout')); ?></span>
                                            </a>
                                          <?php endif; ?>

                                          <?php if(auth()->guard('customer')->guest()): ?>
                                            <a class="unset"
                                               href="<?php echo e(route('customer.session.create')); ?>">
                                      ...
                                      <li>
                                          <?php if(auth()->guard('customer')->guest()): ?>
                                            <a class="unset"
                                               href="<?php echo e(route('customer.register.index')); ?>">
                              ...
                              <div class="wrapper" v-else-if="languages">
                                  <div class="drawer-section">
                                      ...
                                      <h4 class="display-inbl"><?php echo e(__('velocity::app.responsive.header.languages')); ?></h4>
                                  ...
                                  <ul type="none">
                                      <?php $__currentLoopData = $allLocales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                          <a class="unset"
                                             <?php if(isset($serachQuery)): ?> href="?<?php echo e($serachQuery); ?>&locale=<?php echo e($locale->code); ?>"
                                                                                    <?php else: ?>
                                                                                          href="?locale=<?php echo e($locale->code); ?>" <?php endif; ?>>
                                      
                                            <?php if($locale->code == 'en'): ?>
                                              <div class="category-logo">
                                            ...
                                            <span>
                                              <?php echo e(isset($serachQuery) ? $locale->title : $locale->name); ?>
                              ...
                              <div class="wrapper" v-else-if="currencies">
                                  <div class="drawer-section">
                                      ...
                                      <h4 class="display-inbl"><?php echo e(__('velocity::app.shop.general.currencies')); ?></h4>
                                      <i class="material-icons float-right text-dark" @click="closeDrawer()">cancel</i>
                                  </div>
                                      ...
                                      <?php $__currentLoopData = $allCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                          <?php if(isset($serachQuery)): ?>
                                            <a class="unset"
                                               href="?<?php echo e($serachQuery); ?>&locale=<?php echo e($currency->code); ?>">
                                              <span><?php echo e($currency->code); ?></span>
                                            </a>
                                          <?php else: ?>
                                            <a class="unset"
                                               href="?currency=<?php echo e($currency->code); ?>">
                                              <span><?php echo e($currency->code); ?></span>
                                            </a>
                                          <?php endif; ?>
                                        </li>
                      ...
                      <div class="right-vc-header col-6">
                          ...
                          <?php if($showWishlist): ?>
                            <a class="wishlist-btn unset"
                               :href="`<?php echo e(route('customer.wishlist.index')); ?>`">
                              <div class="badge-container"
                                   v-if="wishlistCount > 0">
                                <span class="badge"
                                      v-text="wishlistCount"></span>
                              </div>
      ...
      Vue.component('content-header', {
        ...
        data: function() {
          return {
            ...
            'isSearchbar': false,
            'rootCategories': true,
            'cartItemsCount': '<?php echo e($cartItemsCount); ?>',
            'rootCategoriesCollection': this.$root.sharedRootCategories,
            'isCustomer': '<?php echo e(auth()->guard('customer')->user()
    ? 'true'
    : 'false'); ?>' == "true",
          }
        },
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/prashant/Repo/pegalogics/bagisto/resources/themes/velocity/views/UI/header.blade.php ENDPATH**/ ?>